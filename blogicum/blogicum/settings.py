...
SECRET_KEY = 'django-insecure-72)qx_@u901-c9$)+u1kna5vx%dv^1&c7i416ts4!2=f1=&*t('
...
LOGIN_REDIRECT_URL = 'blog:index'  # ← после входа
LOGOUT_REDIRECT_URL = 'blog:index'  # ← после выхода
